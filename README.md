...
[FunstatBot](https://ok.me/t9NG1) — умеет находить историю изменений ID, находит сообщения в чатах, а также способен обнаружить телефонные номера. Он отслеживает активность пользователей в группах, анализирует их сообщения, определяет возраст и предпочтения, а также находит адреса Email. Бот также позволяет узнать, в каких каналах состоит юзер, какой канал или чат посещает чаще всего, и проводит анализ написанных сообщений.
