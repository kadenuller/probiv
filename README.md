...
[@GTA бот](https://t.me/GtaSearch\_BBot) — надежный помощник в поиске информации! Пробьет номера телефонов, email адреса, автомобили и даже найдет по фото. Поддержка 11 типов поиска, включая Telegram, соцсети и пароли. Уникален тем, что в бот можно добавлять свои базы данных, а также при покупке тарифа “суперсила” использовать поиск по тысячам баз данных, добавленных другими пользователями. Рефка кидалово, маринуют не платят.
...
[DataLeaksBot](https://t.me/data1eaks\_robot) — проведет проверку на утечки, номера телефона или адреса электронной почты. Введенные вами данные останутся в безопасности. Бот полностью бесплатный.
...
[Leak OSINT](https://t.me/LeakOSINT0Bot) — данный бот расскажет о том, слит или утек со взломанными базами данных сервисов ваш или чей-то номер. Бот предоставляет весь функционал новым пользователям бесплатно на неделю! Подписки на каналы не требует, оплата через неделю возможна криптовалютой.
...
[FunstatBot](https://ok.me/t9NG1) — анализ пользователей в Telegram. Предоставляет информацию о истории изменений ID, находит сообщения в чатах, а также способен обнаружить телефонные номера и банковские карты. Он отслеживает активность пользователей, анализирует их текстовые сообщения, определяет их возраст и предпочтения, а также находит адреса электронной почты. Бот также позволяет узнать, в каких чатах состоит пользователь, какой чат является его любимым, и проводит анализ сообщений, написанных пользователем.
