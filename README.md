...
[TrueCallerBot](https://telegram.me/TrueCaller\_Z\_Bot) — бесплатно показывает как ваш номер записан в чужих контактах. Поддерживает номера большинства стран и выдаёт хорошие результаты.
...
[RegDateBot](https://t.me/regdate\_clone\_bot) — этот бот способен сообщить вам примерную дату регистрации аккаунта Telegram по ID пользователя. Вы можете отправить боту ID пользователя Telegram или переслать сообщение, написанное пользователем. Это полезно, когда вам интересно узнать, насколько давно аккаунт был создан. Бот доступен бесплатно и не требует подписки или оплаты.
