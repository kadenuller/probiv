...
[Детектив](https://bit.ly/3YHXWBL) — Пробьет номера телефонов, email адреса. Поддержка шести типов поиска, включая Telegram, соцсети и пароли.
